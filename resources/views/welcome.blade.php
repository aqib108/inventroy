  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <router-link to="/" class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">MyStock</div>
      </router-link>
      ...
      <li class="nav-item active">
        <router-link class="nav-link" to="/Point-of-Sale">
          <i class="fas fa-fw fa-tachometer-alt"></i>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          ...
          <router-link to="/Add-Employee" class="collapse-item">Add Employees</router-link>
          <router-link to="/All-Employee" class="collapse-item">All Employees</router-link>

          </div>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed"  data-toggle="collapse" data-target="#supplier"
          aria-expanded="true" aria-controls="supplier">
          <i class="fa fa-users"></i>
          <span>supplier</span>
</a>
        <div id="supplier" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
      ...
      <li class="nav-item">
        ...
        <div id="category" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          ...
          <router-link to="/All-Category" class="collapse-item">All Category</router-link>

          </div>
        </div>
      </li>
       <li class="nav-item">
        <a class="nav-link collapsed"  data-toggle="collapse" data-target="#customer"
          aria-expanded="true" aria-controls="supplier">
          <i class="fa fa-users"></i>
          <span>Customer</span>
       </a>
        <div id="customer" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          ...
          <router-link to="/All-Customer" class="collapse-item">All Customer</router-link>
      ...
      <li class="nav-item">
        ...
        <div id="product" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          ...
          <router-link to="/All-Product" class="collapse-item">All Product</router-link>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed"  data-toggle="collapse" data-target="#expense"
        ...
        <div id="expense" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          ...
          <router-link to="/All-Expense" class="collapse-item">All Expense</router-link>
      ...
      <li class="nav-item">
        ...
        <div id="salary" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
          <router-link to="/All-Employee" class="collapse-item">Add Salary</router-link>
          <router-link to="/All-Salary" class="collapse-item">All Salary</router-link>
        ...
        <nav id="topbar"  class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top"  v-show="$route.path === '/login' || $route.path === '/register' || $route.path === '/forgot'?false:true " style="display: none !important;"  >
          ...
          <ul class="navbar-nav ml-auto" >
            <li class="nav-item dropdown no-arrow" style="display:none">
              ...
              <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in display-none"
