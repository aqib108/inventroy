<template>
   ...
   <div class="p-3">
    ...
    <router-link to="/All-Customer"  class="mb-3 btn btn-outline-success">View Customers</router-link>
        </div>
   ...
   created()
    {
      ...
      this.id =  this.$route.params.customer_id
...
methods:{
    onChange(e) {
      ...
      update()
      {
        axios.patch('/api/customer/'+this.id,this.form)
        .then(resp=>{
